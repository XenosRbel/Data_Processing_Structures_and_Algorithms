...
namespace Laba_4
{
    class Program
    {
        static void Main(string[] args)
        {
			...
			Console.WriteLine(" На основе динамических списков необходимо реализовать словарь. Основные операции, выполняемые над данными словаря: поиск, вставка и удаление. В сочетании со списками для построения словарей необходимо использовать открытое хеширование данных.");
